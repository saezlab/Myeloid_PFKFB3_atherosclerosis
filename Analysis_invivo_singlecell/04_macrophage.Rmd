---
title: "Role of PHD2 atherogenesis in in-vivo Macrophages"
...
```{r vlnsplit_macrophage_PHD2cKO, fig.with=10, fig.height=6, warning=FALSE}
...
```{r vlnsplit_macrophage_Bnip3, fig.with=10, fig.height=6, warning=FALSE}
...
```{r vlnsplit_macrophage_Spp1, fig.with=10, fig.height=6, warning=FALSE}
